...
exports.getTransactionById = async (req, res) => {
    try {
         ...
         *
         * We check whether the supplied value is a valid
         * MongoDB ObjectId before using findById().
         */
        const isMongoId = /^[0-9a-fA-F]{24}$/.test(transactionId);
        ...
        /*
         * If it was not found by MongoDB _id,
         * try the transaction reference.
         *
         * This allows staff/admin/super admin to paste
         * the reference displayed on the customer's
         * transaction history.
         */
        if (!transaction) {
